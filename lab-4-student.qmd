...
ca_childcare <- ca_childcare |> 
  mutate(county_name = str_remove(county_name, 
         ...
         region = fct_collapse(county_name,
                               "Superior California" = c("Butte", "Colusa", "El Dorado", "Glenn", "Lassen", "Modoc", "Nevada", "Plumas", "Sacramento", "Shasta", "Sierra", "Siskiyou", "Sutter", "Tehama", "Yolo", "Yuba", "Placer"),
                               ...
                               "Southern San Joaquin Valley" = c("Fresno", "Kern", "Kings", "Inyo", "Tulare"),
                               "Inland Empire" = c("Riverside", "San Bernardino"),
                               "San Diego Imperia" = c("San Diego", "Imperial")
  )
  )
